...
import org.firstinspires.ftc.teamcode.utility.math.kinematics.SwerveDriveKinematics;
import org.firstinspires.ftc.teamcode.utility.math.kinematics.SwerveModulePosition;
import org.firstinspires.ftc.teamcode.utility.math.kinematics.SwerveModuleState;
...
public class SwerveKinematics2 extends SwerveDriveKinematics
{
    ...
    private final ElapsedTimer m_moduleAccelTimer    = new ElapsedTimer();
    /**
     * Previous CoR
     */
    ...
    public SwerveModuleState2[] toSwerveModuleStates(
        ...
        ChassisSpeeds accelChassisSpeeds = new ChassisSpeeds(
        ...
        SimpleMatrix moduleVelocityStatesMatrix = m_inverseKinematics.mult(chassisSpeedsVector);
        ...
        SimpleMatrix moduleAccelerationStatesMatrix = bigInverseKinematics.mult(accelerationVector);
    ...
    public ChassisSpeeds toChassisSpeeds(SwerveModuleState2... wheelStates)
    {
        ...
        for (int i = 0; i < m_numModules; i++)
        {
            SwerveModuleState2 module = wheelStates[i];
    ...
    public Twist2d toTwist2d(SwerveModulePosition... wheelDeltas)
    {
        ...
        for (int i = 0; i < m_numModules; i++)
        {
            SwerveModulePosition module = wheelDeltas[i];
