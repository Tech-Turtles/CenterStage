package org.firstinspires.ftc.teamcode.utility.math.system;

import org.firstinspires.ftc.teamcode.utility.math.Matrix;
import org.firstinspires.ftc.teamcode.utility.math.Num;
import org.firstinspires.ftc.teamcode.utility.math.Pair;
...
public class LinearSystem<States extends Num, Inputs extends Num, Outputs extends Num> {
    ...
    public Matrix<States, N1> calculateX(
        ...
        Pair<Matrix<States, States>, Matrix<States, Inputs>> discABpair = Discretization.discretizeAB(m_A, m_B, dtSeconds);
