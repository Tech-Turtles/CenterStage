...
public class ConstraintsZone {
   ...
   * @param constraints The {@link PathConstraints} to apply within the
   *     zone
   */
   ...
   *
   * @param zoneJson A {@link JSONObject} representing a constraints zone
   ...
   *
   * @return The {@link PathConstraints} for this zone
   */
